...
#     }
signalFileEffNames = {
    'L100TeV':'/Users/gillian/Documents/Caltech/Senior/Thesis/DelayedPhotonFiles/MC_Nov24_noIsoCuts_barrelskim/GMSB_L100TeV_Ctau10cm_13TeV-pythia8_pho1Pt_EB.root',
    'L150TeV':'/Users/gillian/Documents/Caltech/Senior/Thesis/DelayedPhotonFiles/MC_Nov24_noIsoCuts_barrelskim/GMSB_L150TeV_Ctau10cm_13TeV-pythia8_pho1Pt_EB.root',
    'L200TeV':'/Users/gillian/Documents/Caltech/Senior/Thesis/DelayedPhotonFiles/MC_Nov24_noIsoCuts_barrelskim/GMSB_L200TeV_Ctau10cm_13TeV-pythia8_pho1Pt_EB.root',
    'L250TeV':'/Users/gillian/Documents/Caltech/Senior/Thesis/DelayedPhotonFiles/MC_Nov24_noIsoCuts_barrelskim/GMSB_L250TeV_Ctau10cm_13TeV-pythia8_pho1Pt_EB.root',
    'L300TeV':'/Users/gillian/Documents/Caltech/Senior/Thesis/DelayedPhotonFiles/MC_Nov24_noIsoCuts_barrelskim/GMSB_L300TeV_Ctau10cm_13TeV-pythia8_pho1Pt_EB.root',
    'L400TeV':'/Users/gillian/Documents/Caltech/Senior/Thesis/DelayedPhotonFiles/MC_Nov24_noIsoCuts_barrelskim/GMSB_L400TeV_Ctau10cm_13TeV-pythia8_pho1Pt_EB.root',
    }
...
test_name = 'Photons_QCD10_masses_time'
...
plt.figure()
plt.hist(disc_bkg['L250TeV'], normed=True, bins=50, alpha=0.3)
plt.hist(disc_signal['L250TeV'], normed=True, bins=50, alpha=0.3)
plt.savefig('mydiscriminator.png')
print "disc_bkg: ", disc_bkg['L250TeV']
print "disc_signal: ", disc_signal['L250TeV']

# evaluate predictions
accuracy = accuracy_score(y_test['L250TeV'], predictions['L250TeV'])
...
#for ctau 200cm
# plt.plot(fpr['L150TeV'], tpr['L150TeV'], color='darkorange',
#          lw=lw, label=r'$\Lambda$ = 150 TeV')
# plt.plot(fpr['L200TeV'], tpr['L200TeV'], color='red',
#          lw=lw, label=r'$\Lambda$ = 200 TeV')
# plt.plot(fpr['L250TeV'], tpr['L250TeV'], color='blue',
#          lw=lw, label=r'$\Lambda$ = 250 TeV')
# plt.plot(fpr['L300TeV'], tpr['L300TeV'], color='green',
#          lw=lw, label=r'$\Lambda$ = 350 TeV')

# for ctau 10cm
plt.plot(fpr['L100TeV'], tpr['L100TeV'], color='red',
        lw=lw, label=r'$\Lambda$ = 100 TeV')
plt.plot(fpr['L150TeV'], tpr['L150TeV'], color='darkorange',
         lw=lw, label=r'$\Lambda$ = 150 TeV')
plt.plot(fpr['L200TeV'], tpr['L200TeV'], color='green',
         lw=lw, label=r'$\Lambda$ = 200 TeV')
plt.plot(fpr['L250TeV'], tpr['L250TeV'], color='blue',
         lw=lw, label=r'$\Lambda$ = 250 TeV')
plt.plot(fpr['L300TeV'], tpr['L300TeV'], color='lightblue',
         lw=lw, label=r'$\Lambda$ = 300 TeV')
plt.plot(fpr['L400TeV'], tpr['L400TeV'], color='purple',
        lw=lw, label=r'$\Lambda$ = 400 TeV')
...
plt.title(r'ROC - GMSB vs. QCD, $c\tau$ = 10 cm, 7 variables + ECAL Timing')
#plt.title(r'ROC - GMSB vs. $\gamma$ + Jets, $c\tau$ = 10 cm, 7 variables')
...
# Plot
plt.figure()
plt.bar(range(len(model['L250TeV'].feature_importances_)), model['L250TeV'].feature_importances_)
plt.show()
...
print "MAXIMUM SIGNIFICANCE = ", max(significance['L250TeV'])
